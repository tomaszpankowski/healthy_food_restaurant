...
class Footer extends Component{
    render(){
        return(
            <footer>
                <Container fluid className="d-flex text-dark align-items-center bg-dark pt-3 opacity-9 border-top border-dark">
                    <Row className="mx-0 w-100 small opacity-9">
                        ...
                        <Col xs={12} className="text-center border-top border-dark">
                            <p className="mb-1">
                                ...
                                <Link to="/privacy" className="fw-bold text-dark text-decoration-none">
                                    Privacy policy
                                </Link>
                            </p>
                        </Col>
