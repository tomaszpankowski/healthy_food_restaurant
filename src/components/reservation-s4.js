...
class ReservationS4 extends Component{
    render(){
        return(    
            <Container fluid className="reservation-s4 d-flex minh-50vh align-items-center border-top border-dark py-5 bg-secondary">
