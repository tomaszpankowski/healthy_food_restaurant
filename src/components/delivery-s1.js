...
class DeliveryS1 extends Component{
    render(){
        return(    
            <Container fluid className="delivery-s1 d-flex minh-50vh align-items-center py-5 border-top border-secondary pt-5">
